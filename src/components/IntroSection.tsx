...
const IntroSection: React.FC = () => {
  return (
    <section className="section section-intro section-intro-home" id="section-intro" data-theme-section="dark">
      <div className="container">
        <div className="row split">
          <div className="col">
            <h3><span>The AI Revolution</span></h3>
          </div>
        </div>
        <div className="row split">
          <div className="col">
          ...
          <div className="col">
            <div className="col-row">
              <h4>
                The future of AI economy is here.<br/><br/>
                $UNREAL utility token = one AI job (any model, any complexity).<br/><br/>
                Startups earn tokens for usage; tokens are burned on each job → deflationary.<br/><br/>
                Governance: 1-member-1-vote cooperative (250M fixed supply, 35% founder, 15% DecenterAI).
              </h4>
            </div>
            ...
            <div className="col-row">
              <div className="btn btn-primary">
                <a href="https://app.unreal.economy" className="btn-click">
