            ...
            <div className="mission-content">
              ...
              <div className="mission-section">
                ...
                <p className="section-description">
                  To create a unified ecosystem where one token grants access to
                  all AI tools. We're building the infrastructure for the next
                  generation of AI-powered applications, eliminating
                  fragmentation and making advanced AI accessible to everyone.
                </p>
              </div>
              ...
              <div className="mission-pillars">
                <div className="pillar">
                  ...
                  <p>
                    One platform, one token - breaking down barriers between
                ...
                <div className="pillar">
                  ...
                  <p>
                    Pushing the boundaries of what's possible when AI meets
                ...
                <div className="pillar">
                  ...
                  <p>
                    Built by creators, for creators - powered by the community
                    that uses it.
                  </p>
                </div>
              </div>
            ...
            <div className="vision-content">
              <div className="vision-section">
                ...
                <div className="vision-description">
                  <p>
                    A world where AI innovation isn't limited by fragmented
                    tools, complex integrations, or financial barriers. Where
                    creators can focus on building the future instead of
                    managing multiple subscriptions and APIs. Where one token
                    powers an infinite studio of possibilities.
                  </p>
                </div>
              </div>
              ...
              <div className="vision-highlight">
                ...
                <div className="btn btn-primary">
                  <a href="https://art.ideomind.org" className="btn-click">
